        ...
        <div>
            <div style={{ width: '100%', height: '100%' }}>
                <Image
                    ...
                    width={imageWidth} // Usar la variable para la anchura
                    height={imageHeight}
                    style={{
                        objectFit: 'cover',
            ...
            <Container style={{ position: 'absolute', top: '70%', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 1 }} >
                <Row>
